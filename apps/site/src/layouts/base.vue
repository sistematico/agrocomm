    ...
    <div class="p-navigation__row">
      ...
      <nav class="p-navigation__nav" aria-label="Example main">
        ...
        <ul class="p-navigation__items">
          ...
          <li class="p-navigation__item">
            <a class="p-navigation__link" href="#iot"> IoT </a>
          </li>
          <li class="p-navigation__item">
            <a class="p-navigation__link" href="#build"> Build </a>
          </li>
          <li class="p-navigation__item">
          ...
          <li class="p-navigation__item">
            <a class="p-navigation__link" href="#"> Forum </a>
          </li>
        </ul>
        ...
        <ul class="p-navigation__items">
          ...
          >
            ...
            >
              <li>
                <a href="#account/snaps" class="p-navigation__dropdown-item"
                  >My published snaps</a
                >
              </li>
              <li>
                <a href="#build" class="p-navigation__dropdown-item"
                  >Build with GitHub</a
                >
              </li>
              <li>
                <a href="#account/details" class="p-navigation__dropdown-item"
                  >Account details</a
                >
              </li>
              <li>
                <a href="#logout" class="p-navigation__dropdown-item"
                  >Sign out</a
                >
              </li>
            </ul>
  ...
  <div id="main-content">
    <section class="p-strip is-shallow u-no-padding--bottom">
      <div class="u-fixed-width">
        ...
        <h1 class="p-heading--3">my-awesome-snap</h1>

        <nav class="p-tabs" aria-label="Example tabs navigation">
          <ul
            class="p-tabs__list u-float-right u-no-margin--bottom"
            role="tablist"
          >
            ...
            <ul class="p-side-navigation__list">
              <li class="p-side-navigation__item">
                <a
                  ...
                  aria-current="page"
                  href="#publicise"
                  >Snap Store buttons</a
                >
              </li>
              <li class="p-side-navigation__item">
                <a class="p-side-navigation__link" href="#publicise/badges"
                  >GitHub badges</a
                >
              </li>
              <li class="p-side-navigation__item">
                <a class="p-side-navigation__link" href="#publicise/cards"
                  >Embeddable cards</a
                >
              </li>
            </ul>
          ...
          <div class="row">
            ...
            <div class="col-7">
              ...
              <p>
                ...
                <a href="#" target="_blank">in this repository</a>.
              </p>
            </div>
          </div>
                    ...
                    <p class="snapcraft-publicise__images">
                      <a href="#">
                        <img
                          ...
                          src="https://assets.ubuntu.com/v1/03dad919-%5BEN%5D-snap-store-black-uneditable.svg"
                        />
                      </a>
                    </p>
                  </div>
                  ...
                  <div class="col-5">
                    <p class="snapcraft-publicise__images">
                      <a href="#">
                        <img
                          alt="Get it from the Snap Store"
                          src="https://assets.ubuntu.com/v1/fa3c60f8-%5BEN%5D-snap-store-white-uneditable.svg"
                        />
                      </a>
                    </p>
                  </div>
...
&lt;/a&gt;</code></pre>
          ...
          <div class="row">
            <div class="col-2">Download all:</div>
            <div class="col-7">
  ...
  <footer class="p-strip--light p-sticky-footer" id="footer">
    <div class="row">
      <div class="col-9">
        <p>
          <a class="p-link--soft" href="#"
            >Back to top<i class="p-icon--top"></i
          ></a>
        </p>
        <p>
        ...
        <p class="u-no-limit">
          <small>
            <a href="#">Join the forum</a>, contribute to or report problems
            with, <a href="#">snapd</a>, <a href="#">Snapcraft</a>, or
            <a href="#">this site</a>.
          </small>
        </p>
      </div>
    ...
    <div class="u-fixed-width">
      <ul class="p-inline-list--middot u-no-margin--bottom">
        <li class="p-inline-list__item">
          <a class="p-link--soft" accesskey="6" href="#"
            ><small>Legal information</small></a
          >
        </li>
        <li class="p-inline-list__item">
          <a class="p-link--soft" accesskey="7" href="#"
            ><small>Data privacy</small></a
          >
        </li>
        <li class="p-inline-list__item">
          <a class="p-link--soft" accesskey="8" href="#"
            ><small>Service status</small></a
          >
        </li>
        <li class="p-inline-list__item">
          <a class="p-link--soft" accesskey="9" href="#"
            ><small>Other functions</small></a
          >
        </li>
      </ul>
    </div>
